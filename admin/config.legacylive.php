...
/* $Id: phpESP.ini.php,v 1.51 2007/12/30 18:35:20 liedekef Exp $ */
...
$ESPCONFIG['subdir_url'] = '';

// URL of the images directory (for <img src='...'> tags)
$ESPCONFIG['image_url'] = $ESPCONFIG['base_url'] . $ESPCONFIG['subdir_url'] . '/images/';

$ESPCONFIG['logo_url'] = $ESPCONFIG['image_url'] . 'OpenVULab.png';

// URL of the automatic survey publisher
$ESPCONFIG['autopub_url'] = $ESPCONFIG['base_url'] . $ESPCONFIG['subdir_url'] . '/public/survey.php';

// URL of the CSS directory (for themes)
$ESPCONFIG['css_url'] = $ESPCONFIG['base_url'] . $ESPCONFIG['subdir_url'] . '/public/css/';

//URL for management javascript
$ESPCONFIG['js_url'] = $ESPCONFIG['base_url'] . $ESPCONFIG['subdir_url'] . '/js/';

// Database connection information
$ESPCONFIG['db_host'] = $db['main']['host'];
$ESPCONFIG['db_user'] = $db['main']['user'];
$ESPCONFIG['db_pass'] = $db['main']['pass'];
$ESPCONFIG['db_name'] = $db['main']['dbname'];
...
$ESPCONFIG['adodb_pathto_db'] = "/vulab/www/scripts/db/esp.dbm";
...
$ESPCONFIG['email_from_name'] = "openVuLab";
$ESPCONFIG['email_from_address'] = "vulab@". $_SERVER['SERVER_NAME'];
...
@$ESPCONFIG['email_invite_name'];
@$ESPCONFIG['email_invite_address'];
@$ESPCONFIG['email_reply'];
...
$ESPCONFIG['ME'] = $ESPCONFIG['base_url'].$_SERVER['PHP_SELF'];

// CSS stylesheet to use for designer interface
$ESPCONFIG['style_sheet'] = $ESPCONFIG['base_url'] . $ESPCONFIG['subdir_url'] . '/admin/style.css';
...
$ESPCONFIG['project_table']           = $DB_PREFIX."project";
$ESPCONFIG['user_table']				= $DB_PREFIX."user";


// Debug mode
$ESPCONFIG['debug_mode'] = 1;
...
// E-mail details
$ESPCONFIG['email']['to'] = "dmakalsky@gmail.com";
$ESPCONFIG['email']['subject'] = "New Researcher Signup";
// default thank you messages
$ESPCONFIG['thank_head'] = _('Thank You For Completing This Survey. <br />Please do not use the back button on your browser to go
back. <br /> <a href="javascript:self.close();">done</a>');
